...
from app.api.v1.endpoints import facilities, medical_data
...
api_router.include_router(facilities.api_router, tags=["facilities"])  # Changed from .router to .api_router
